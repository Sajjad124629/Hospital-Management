  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal" style="font-size: 2.5rem">About Us</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 style="font-size:2.5rem" class="text-center mb-3">{{$homedata->homeBodyTitle}}</h1>
          <div class="text-lg">
            <p>{{$homedata->homeBodydescription}}</p>
