  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2"><a href="/map">Northern University of Business And Technology Khulna</a> </p>
          ...
          <div class="footer-sosmed mt-3">
            ...
            <a href="https://accounts.google.com/" target="_blank"><span class="mai-logo-google-plus-g"></span></a>
